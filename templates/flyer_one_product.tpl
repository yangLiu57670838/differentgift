                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="600px" id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent">
                                            	{/literal}<img src="{$image_url}" style="max-width:600px;" id="headerImage" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />{literal}
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- // END HEADER -->
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="560px" id="templateBody">
                                        <tr>
                                            <td valign="top" class="bodyContent" mc:edit="body_content00">
                                                <h1>Dear Customer</h1>
                                                {/literal}<h3>{$title}</h3>{literal}
                                                {/literal}{$econtent}{literal}
                                            </td>
                                        </tr>
                                    	<tr>
                                        	<td class="bodyContent" style="padding-top:0; padding-bottom:0;">
                                            	{/literal}<img src="{$product_image_url}" style="max-width:560px;" id="bodyImage" mc:label="body_image" mc:edit="body_image" mc:allowtext />{literal}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top" class="bodyContent" mc:edit="body_content01">
                                                {/literal}<h2>{$product_name}</h2>{literal}
                                                <h4>Detail:</h4>		
